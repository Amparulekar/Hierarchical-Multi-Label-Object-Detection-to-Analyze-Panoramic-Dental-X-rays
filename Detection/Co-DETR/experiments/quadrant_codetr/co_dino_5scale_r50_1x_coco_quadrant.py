...
data = dict(
    ...
    train=dict(
        ...
        ann_file='data/dental/annotations/train_quadrant.json',
        img_prefix='data/dental/train/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='DentalQuadrantDataset',
        ann_file='data/dental/annotations/val_quadrant.json',
        img_prefix='data/dental/val/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        type='DentalQuadrantDataset',
        ann_file='data/dental/annotations/test_quadrant.json',
        img_prefix='data/dental/test/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
work_dir = 'experiments/quadrant_codetr/'
auto_resume = False
gpu_ids = range(0, 4)
